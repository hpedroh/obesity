...
O modelo escolhido foi o **Random Forest Classifier** por ser um algoritmo robusto que combina múltiplas árvores de decisão.
...
Aqui vemos a performance isolada. Note como o modelo é extremamente preciso nas categorias extremas (Abiaxo do Peso e Obesidade III), indicadas pelas cores mais verdes.
